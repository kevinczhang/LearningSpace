...
Just taking the **"never use** `==`**, always use** `===`**"** mantra can be overkill and, frankly, unnecessary if you understand the logic used above in handling non-strict comparison checking.
