...
Keep in mind, a failure \(_rejection or thrown exception_\) of _any_ of the Promises in the array passed to `Promise.all()` will cause the Promise it returns to be rejected.
